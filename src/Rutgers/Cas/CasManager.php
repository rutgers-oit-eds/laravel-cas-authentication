...
class CasManager {
	...
	public function __construct( array $config ) {
        ...
        if ( $this->config['cas_debug'] === true ) {
            ...
            $logger->pushHandler(new StreamHandler($this->config['cas_log_path'] . $this->config['cas_log_name'], Logger::DEBUG));
	...
	protected function configureCas( $method = 'client' ) {
		...
		phpCAS::$method( $server_type, $this->config['cas_hostname'],
			...
			$this->config['cas_uri'], $this->config['cas_base_service_url'], 
